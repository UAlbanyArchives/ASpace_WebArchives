...
if sys.version_info[0] < 3:
	...
	webUrl = input("What URL would you like to look for?")
	archiveItCollection = input("Which Archive-it collection would you like to look in?: ")
...
if archiveItCollection.lower().strip() == "ia":
	URLroot = "https://web.archive.org/cdx/search/cdx?url="
else:
	URLroot = "http://wayback.archive-it.org/" + archiveItCollection + "/timemap/cdx?url="
